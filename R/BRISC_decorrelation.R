BRISC_decorrelation <- function(coords, sim, sigma.sq = 1, tau.sq = 0, phi = 1, nu = 0.5, n.neighbors = 15, n_omp = 1,
  ...
  ##estimtion
  result <- .Call("BRISC_decorrelationcpp", n, n.neighbors, coords, cov.model.indx, alpha.sq.starting, phi.starting, nu.starting, search.type.indx, n.omp.threads, verbose, sim, sim_number, fix_nugget)
